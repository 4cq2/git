...
var (
	Err_Already_Up_To_Date     = errors.New("already up-to-date")
...
// Push performs a push to the remote. Returns Err_Already_Up_To_Date if the
...
func (r *Remote) fetch(ctx context.Context, o *FetchOptions) (sto storer.ReferenceStorer, err error) {
	...
	if !updated {
		return remoteRefs, Err_Already_Up_To_Date
	}
